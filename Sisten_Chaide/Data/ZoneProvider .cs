...
namespace Sisten_Chaide.Data
{
    public class ZoneProvider
    {
                ...
                try
                {
                    ...
                    while (r.Read())
                    {
                        Zone z = new Zone();
                        {
                            ...
                            z.strCalendarInitHour = r["inicio"].ToString();
                            z.srtCalendarEndHour = r["fin"].ToString();
        ...
        public void Add(Zone zone, long userID)
        {
            ...
            /* DateTime initHour = DateTime.ParseExact(zone.strCalendarInitHour, "HH:mm:ss", CultureInfo.InvariantCulture);
             DateTime endHour = DateTime.ParseExact(zone.srtCalendarEndHour, "HH:mm:ss", CultureInfo.InvariantCulture);
           */
            string initHour = (zone.strCalendarInitHour);
            string endHour = (zone.srtCalendarEndHour);
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Parameters.AddWithValue("@inicio", initHour);
                cmd.Parameters.AddWithValue("@fin", endHour);
